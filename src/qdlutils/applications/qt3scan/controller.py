...
class QT3ScanConfocalApplicationController:
    """
    Implements qdlutils.applications.qt3scan.interface.QT3ScanApplicationControllerInterface
    ...
    def __init__(self,
        ...
        self.daq_and_scanner = qdlutils.datagenerators.CounterAndScanner(daq_controller, position_controller)
