...
class MainApplicationView:
    ...
    def show_optimization_plot(self, title: str,
        ...
        fit_coeff: the fit coefficients of the function qdlutils.datagenerators.piezoscanner.gauss
        """
        win = tk.Toplevel()
        win.title(title)
        fig, ax = plt.subplots()
        ...
        if fit_coeff is not None:
            y_fit = qdlutils.datagenerators.piezoscanner.gauss(x_vals, *fit_coeff)
