...
import qdlutils.experiments.common
...
def signal_to_background(trace, pre_trigger, aom_width, rf_pulse_duration, verbose=False,
                        aom_width_duty = 1.0):
    '''
    Assumes trace produced by qdlutils.experiments.rabi.Rabi class and
...
class Rabi(qdlutils.experiments.common.Experiment):
    ...
    def __init__(self, podmr_pulser, rfsynth, edge_counter_config,
        ...
        Hardware Settings
            podmr_pulser - a qdlutils.pulsers.interface.ODMRPulser object (such as qdlutils.pulsers.qcsapphire.QCSapphPulsedODMRPulser)
            rfsynth - a qt3rfsynthcontrol.Pulser object
            edge_counter_config - a qdlutils.nidaq.config.EdgeCounter object
        ...
        qdlutils.experiments.cwodmr.aggregate_data.
    ...
    def _acquire_data_at_parameter(self, rf_pulse_duration, N_cycles = 10000,
                              post_process_function = qdlutils.experiments.podmr.simple_measure_contrast):
