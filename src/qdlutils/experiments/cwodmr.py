...
class CWODMR(qdlutils.experiments.common.Experiment):
    ...
    def __init__(self, cwodmr_pulser, rfsynth, edge_counter_config,
        ...
        Hardware Settings
            cwodmr_pulser - a qdlutils.pulsers.interface.ODMRPulser object (such as qdlutils.pulsers.qcsapphire.QCSapphCWODMRPulser)
