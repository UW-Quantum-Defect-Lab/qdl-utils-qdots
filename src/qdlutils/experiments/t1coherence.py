...
# ^ This reference appears to have been broken a long time ago?
# I don't think that it was working before we even forked it...
...
def aggregate_data(data_buffer, rabi):
    '''
    Calls qdlutils.analysis.aggregation.reshape_sum_trace, where
        cwodmr.N_cycles = N_rows
        cwodmr.N_clock_ticks_per_cycle = N_samples_per_row

    '''
    return qdlutils.analysis.aggregation.reshape_sum_trace(data_buffer,
                                                           rabi.N_cycles,
