...
import qdlutils.hardware.nidaq.daqsamplers as daqsamplers
...
class QT3ScopeNIDAQEdgeCounterController:
    """
    Implements the qdlutils.applications.qt3scope.interface.QT3ScopeDataControllerInterface for a NIDAQ edge counter.
    """
...
class QT3ScanNIDAQEdgeCounterController(QT3ScopeNIDAQEdgeCounterController):
    """
    Implements the qdlutils.applications.qt3scan.interface.QT3ScanCounterDAQControllerInterface for a NIDAQ edge counter.
    """
    def __init__(self, logger_level):
