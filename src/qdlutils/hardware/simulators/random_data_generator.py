...
import qdlutils.datagenerators.daqsamplers
import qdlutils.datagenerators


class QT3ScopeRandomDataController:
    """
    Implements the qdlutils.applications.qt3scope.interface.QT3ScopeDAQControllerInterface for a random data generator.
    """
    ...
    def __init__(self, logger_level):
        ...
        self.data_generator = qdlutils.datagenerators.daqsamplers.RandomRateCounter()
...
class QT3ScanRandomDataController(QT3ScopeRandomDataController):
    """
    Implements the qdlutils.applications.qt3scan.interface.QT3ScanDAQControllerInterface for a random data generator.
    """
...
class QT3ScanRandomSpectrometerDataController:
    """
    Implements qdlutils.applications.qt3scan.interface.QT3ScanSpectrometerDAQControllerInterface
    """
...
class QT3ScanDummyPositionController:
    """
    Implements the qdlutils.applications.qt3scan.interface.QT3ScanPositionControllerInterface for a dummy position controller.
    """
    def __init__(self, logger_level):
        self.logger = logging.getLogger(__name__)
        self.logger.setLevel(logger_level)
